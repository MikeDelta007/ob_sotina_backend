...
public class GPdfHarness {

    private RelevNoteG base() {
        RelevNoteG r = new RelevNoteG();
        ...
        List<Matiere> mats = MatieresG.PREMIER_GROUPE;
    ...
    void scenario1erGroupeSeul() throws Exception {
        ...
        genererEtEcrire(r, "target/g-1ergroupe.pdf");
    }
    ...
    void scenario2emeGroupe() throws Exception {
        ...
        ctrl.setMatiereChoisie("Economie Generale");
        ...
        genererEtEcrire(r, "target/g-2emegroupe.pdf");
    }

    private void genererEtEcrire(RelevNoteG r, String path) throws Exception {
        RelevNoteGPdfService service = new RelevNoteGPdfService();
