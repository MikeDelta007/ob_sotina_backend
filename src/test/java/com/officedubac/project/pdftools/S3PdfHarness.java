...
public class S3PdfHarness {

    private RelevNoteS3 base() {
        RelevNoteS3 r = new RelevNoteS3();
        ...
        int total = 0;
        for (Matiere m : MatieresS3.PREMIER_GROUPE) {
            int note = 12;
    ...
    void scenarioPremierGroupeSeul() throws Exception {
        ...
        write(r, "target/s3-echantillon-g1.pdf");
    }
    ...
    void scenarioDeuxiemeGroupe() throws Exception {
        ...
        write(r, "target/s3-echantillon-g2.pdf");
    }

    private void write(RelevNoteS3 r, String path) throws Exception {
        RelevNoteS3PdfService service = new RelevNoteS3PdfService();
