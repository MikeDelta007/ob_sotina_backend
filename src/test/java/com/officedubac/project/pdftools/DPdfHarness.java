...
public class DPdfHarness {

    @Test
    void genererEchantillon() throws Exception {
        RelevNoteD r = new RelevNoteD();
        ...
        List<Matiere> g1 = MatieresD.PREMIER_GROUPE;
        ...
        RelevNoteDPdfService service = new RelevNoteDPdfService();
        byte[] pdf = service.genererPdf(r);
        try (FileOutputStream fos = new FileOutputStream("target/d-echantillon-g1.pdf")) {
            fos.write(pdf);
        }
        ...
        try (FileOutputStream fos = new FileOutputStream("target/d-echantillon-g2.pdf")) {
            fos.write(pdf2);
        }
    }
