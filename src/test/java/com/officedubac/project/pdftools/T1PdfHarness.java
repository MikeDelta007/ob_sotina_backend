...
public class T1PdfHarness {

    private RelevNoteT1 base() {
        RelevNoteT1 r = new RelevNoteT1();
        ...
        int total = 0;
        for (Matiere m : MatieresT1.PREMIER_GROUPE) {
            int note = 12;
    ...
    void scenarioPremierGroupeSeul() throws Exception {
        ...
        write(r, "target/t1-echantillon-g1.pdf");
    }
    ...
    void scenarioDeuxiemeGroupe() throws Exception {
        ...
        write(r, "target/t1-echantillon-g2.pdf");
    }

    private void write(RelevNoteT1 r, String path) throws Exception {
        RelevNoteT1PdfService service = new RelevNoteT1PdfService();
