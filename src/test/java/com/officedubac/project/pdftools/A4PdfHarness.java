...
public class A4PdfHarness {

    @Test
    void genererEchantillon() throws Exception {
        RelevNoteA4 r = new RelevNoteA4();
        ...
        List<Matiere> g1 = MatieresA4.PREMIER_GROUPE;
        ...
        RelevNoteA4PdfService service = new RelevNoteA4PdfService();
        byte[] pdf = service.genererPdf(r);
        try (FileOutputStream fos = new FileOutputStream("target/a4-echantillon-g1.pdf")) {
            fos.write(pdf);
        }
        ...
        try (FileOutputStream fos = new FileOutputStream("target/a4-echantillon-g2.pdf")) {
            fos.write(pdf2);
        }
    }
