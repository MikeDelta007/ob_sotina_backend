...
public class A3PdfHarness {

    @Test
    void genererEchantillon() throws Exception {
        RelevNoteA3 r = new RelevNoteA3();
        ...
        List<Matiere> g1 = MatieresA3.PREMIER_GROUPE;
        ...
        // Scénario 1 : arrêt au 1er groupe (pas de 2e groupe)
        ...
        RelevNoteA3PdfService service = new RelevNoteA3PdfService();
        byte[] pdf = service.genererPdf(r);
        try (FileOutputStream fos = new FileOutputStream("target/a3-echantillon-g1.pdf")) {
            fos.write(pdf);
        }

        // Scénario 2 : passage par le 2e groupe
        ...
        try (FileOutputStream fos = new FileOutputStream("target/a3-echantillon-g2.pdf")) {
            fos.write(pdf2);
        }
    }
