...
public class S4PdfHarness {

    private RelevNoteS4 base() {
        RelevNoteS4 r = new RelevNoteS4();
        ...
        int total = 0;
        for (Matiere m : MatieresS4.PREMIER_GROUPE) {
            int note = 12;
    ...
    void scenarioPremierGroupeSeul() throws Exception {
        ...
        write(r, "target/s4-echantillon-g1.pdf");
    }
    ...
    void scenarioDeuxiemeGroupe() throws Exception {
        ...
        write(r, "target/s4-echantillon-g2.pdf");
    }

    private void write(RelevNoteS4 r, String path) throws Exception {
        RelevNoteS4PdfService service = new RelevNoteS4PdfService();
