...
public class G1PdfHarness {

    private RelevNoteG1 base() {
        RelevNoteG1 r = new RelevNoteG1();
        ...
        List<Matiere> mats = MatieresG1.PREMIER_GROUPE;
    ...
    void scenario1erGroupeSeul() throws Exception {
        ...
        genererEtEcrire(r, "target/g1-1ergroupe.pdf");
    }
    ...
    void scenario2emeGroupe() throws Exception {
        ...
        genererEtEcrire(r, "target/g1-2emegroupe.pdf");
    }

    private void genererEtEcrire(RelevNoteG1 r, String path) throws Exception {
        RelevNoteG1PdfService service = new RelevNoteG1PdfService();
