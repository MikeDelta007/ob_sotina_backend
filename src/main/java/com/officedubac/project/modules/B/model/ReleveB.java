...
@Document(collection = "relevesNotesB")
public class ReleveB {
    ...
    // ---- 1er groupe d'épreuves (barème 500) ----
    private List<NoteEpreuve> notesPremierGroupe = new ArrayList<>();
    private Integer totalPremierGroupe; // sur 500 (= 1er TOTAL = 2eme TOTAL, reporté)
    ...
    private Integer totalDefinitif; // sur 500
