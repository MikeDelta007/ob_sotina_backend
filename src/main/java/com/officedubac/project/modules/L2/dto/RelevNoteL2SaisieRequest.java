package com.officedubac.project.modules.L2.dto;

import com.officedubac.project.modules.L2.model.Enums.TypeSession;
...
public class RelevNoteL2SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresL2.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresL2.DEUXIEME_GROUPE), valeur = note sur 20 */
