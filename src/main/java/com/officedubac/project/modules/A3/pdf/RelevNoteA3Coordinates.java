 ...
 * extraction du texte du gabarit officiel "releve-A3-template.pdf"
...
public final class RelevNoteA3Coordinates {
    ...
    public static final float SESSION_NORMALE_X0 = 185.3f, SESSION_NORMALE_X1 = 225.3f, SESSION_NORMALE_Y = 711.0f;
    public static final float SESSION_REMPLACEMENT_X0 = 185.3f, SESSION_REMPLACEMENT_X1 = 267.3f, SESSION_REMPLACEMENT_Y = 698.7f;

    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 370.3f, JURY_NUMERO_Y = 711.0f;
    public static final float ANNEE_X = 380.3f, ANNEE_Y = 698.7f;
    ...
    public static final float[] G1_ROW_Y = { 521.6f, 507.0f, 494.0f, 479.7f, 465.5f, 451.6f, 437.1f, 422.7f };

    public static final float G1_TOTAL_Y = 364.6f;
    public static final float G2_TOTAL_Y = 307.1f;
    ...
    public static final float CTRL_FIRST_ROW_Y = 464.8f;
    public static final float CTRL_ROW_HEIGHT = 14.3f;

    // ---- Epreuves facultatives (droite, alimentent le TOTAL DEFINITIF) ----
    public static final float FAC_LANGUE_X = 470.9f, FAC_LANGUE_Y = 405.4f;
    public static final float FAC_ARTS_X = 525.0f, FAC_ARTS_Y = 384.6f;

    // ---- Epreuve facultative + Education Physique (gauche, alimentent le 2ème TOTAL) ----
    public static final float FAC_LANGUE_GAUCHE_X = 196.3f, FAC_LANGUE_GAUCHE_Y = 347.0f;
    public static final float FAC_ARTS_GAUCHE_X = 216.3f, FAC_ARTS_GAUCHE_Y = 327.5f;
    public static final float FAC_EDUCPHYS_GAUCHE_X = 165f, FAC_EDUCPHYS_GAUCHE_Y = 398.6f;
    ...
    public static final float EP_NOTE_X = 89.2f, EP_NOTE_Y = 395.5f;
    public static final float EP_POS_X = 196.3f, EP_POS_Y = 405.4f;
    public static final float EP_NEG_X = 196.3f, EP_NEG_Y = 384.6f;
    public static final float TOTAL_DEFINITIF_Y = 365.0f;

    // ---- Décisions du jury : texte libre sur la ligne "Le candidat a été déclaré ..." ----
    public static final float DEC1_TEXTE_X = 179.2f, DEC1_TEXTE_Y = 275.7f;
    public static final float DEC2_TEXTE_X = 425.7f, DEC2_TEXTE_Y = 326.7f;

    // ---- Pied de page 1er groupe : "Fait à ... le ... 19..." (format court) ----
    public static final float DEC1_LIEU_X = 64.2f, DEC1_JOUR_MOIS_X = 129.2f, DEC1_ANNEE2_X = 229.2f, DEC1_PIED_Y = 214.8f;

    // ---- Pied de page 2eme groupe (format long) ----
    public static final float DEC2_LIEU_X = 310.7f, DEC2_JOUR_MOIS_X = 435.7f, DEC2_ANNEE2_X = 555.7f, DEC2_PIED_Y = 273.4f;
}
