package com.officedubac.project.modules.A3.dto;
...
/**
 * Ce que le frontend envoie pour saisir/mettre à jour un relevé A3.
 * Seules les notes brutes sont reçues : points, totaux, mention et décision
 * sont recalculés côté serveur.
 */
public class ReleveA3SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresA3.PREMIER_GROUPE), valeur = note sur 20 */
