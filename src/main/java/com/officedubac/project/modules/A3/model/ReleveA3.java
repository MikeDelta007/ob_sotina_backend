...
import com.officedubac.project.modules.A3.model.Enums.TypeSession;
...
@Document(collection = "relevesNotesA3")
public class ReleveA3 {
    ...
    public List<EpreuveOraleControle> getEpreuvesDeControle() { return epreuvesDeControle; }
    public void setEpreuvesDeControle(List<EpreuveOraleControle> epreuvesDeControle) { this.epreuvesDeControle = epreuvesDeControle; }
