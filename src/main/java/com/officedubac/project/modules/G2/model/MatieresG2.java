package com.officedubac.project.modules.G2.model;

import java.util.List;

import static com.officedubac.project.modules.G2.model.GroupeEpreuves.DEUXIEME;
import static com.officedubac.project.modules.G2.model.GroupeEpreuves.PREMIER;
import static com.officedubac.project.modules.G2.model.TypeEpreuve.ECRIT;
import static com.officedubac.project.modules.G2.model.TypeEpreuve.ORAL;

/**
 * Référentiel figé des matières, coefficients et barèmes de la série G2
 * (Techniques Quantitatives de Gestion), tel qu'imprimé sur le gabarit officiel de
 * l'Office du Baccalauréat.
 */
public final class MatieresG2 {
    ...
    public static final Matiere CORRESPON_DACTYLO = new Matiere("CORRESPON_DACTYLO", "Correspondance Dactylographiée", 2, 40, ECRIT, PREMIER);
    public static final Matiere LV1 = new Matiere("LV1", "Langue Vivante I", 2, 40, ORAL, PREMIER);
    public static final Matiere LV2 = new Matiere("LV2", "Langue Vivante II", 2, 40, ECRIT, PREMIER);

    public static final List<Matiere> PREMIER_GROUPE = List.of(FR_ECRIT, FR_ORAL, PHILO, MATH, ECONOMIE, ETUDE_CAS, CONN_MONDE, CORRESPON_DACTYLO, LV1, LV2);
    ...
    public static Matiere findByCode(String code) {
        return java.util.stream.Stream.concat(PREMIER_GROUPE.stream(), DEUXIEME_GROUPE.stream())
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Matière inconnue pour la série G2 : " + code));
    }
}
