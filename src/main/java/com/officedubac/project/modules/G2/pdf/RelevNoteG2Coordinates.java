...
public final class RelevNoteG2Coordinates {
    ...
    public static final float DEC1_TEXTE_X = 179.2f, DEC1_TEXTE_Y = 248.1f;
    public static final float DEC2_TEXTE_X = 425.7f, DEC2_TEXTE_Y = 299.1f;

    // ---- Pied de page 1er groupe : "Fait à ... le ... 19..." (format court) ----
    public static final float DEC1_LIEU_X = 64.2f, DEC1_JOUR_MOIS_X = 129.2f, DEC1_ANNEE2_X = 229.2f, DEC1_PIED_Y = 187.2f;

    // ---- Pied de page 2eme groupe (format long) ----
    public static final float DEC2_LIEU_X = 310.7f, DEC2_JOUR_MOIS_X = 435.7f, DEC2_ANNEE2_X = 555.7f, DEC2_PIED_Y = 245.8f;
}
