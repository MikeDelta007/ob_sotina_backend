package com.officedubac.project.modules.G2.dto;

import com.officedubac.project.modules.G2.model.Enums.TypeSession;
...
public class RelevNoteG2SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresG2.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresG2.DEUXIEME_GROUPE), valeur = note sur 20 */
