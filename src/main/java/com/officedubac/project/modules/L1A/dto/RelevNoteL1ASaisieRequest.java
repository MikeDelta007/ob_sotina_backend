...
public class RelevNoteL1ASaisieRequest {
    ...
    /** clé = code matière (cf. MatieresL1A.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresL1A.DEUXIEME_GROUPE), valeur = note sur 20 */
