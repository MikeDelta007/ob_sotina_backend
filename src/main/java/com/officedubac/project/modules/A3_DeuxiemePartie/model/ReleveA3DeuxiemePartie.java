...
import com.officedubac.project.modules.A3_DeuxiemePartie.model.Enums.DecisionJury;
...
@Document(collection = "relevesNotesA3DeuxiemePartie")
public class ReleveA3DeuxiemePartie {
    ...
    private Integer totalEcrit; // sur 240

    private List<NoteEpreuve> notesOrales = new ArrayList<>();
    private Integer totalOral;  // sur 80

    private Integer totalGeneral; // sur 320
