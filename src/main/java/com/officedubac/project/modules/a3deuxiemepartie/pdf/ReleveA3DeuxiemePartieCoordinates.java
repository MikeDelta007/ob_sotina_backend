...
public final class ReleveA3DeuxiemePartieCoordinates {
    ...
    public static final float NUMERO_TABLE_X = 348.9f, NUMERO_TABLE_Y = 649f;

    public static final float NOM_PRENOM_X = 44.3f, NOM_PRENOM_Y = 602f;
    public static final float DATE_NAISSANCE_X = 78.3f, DATE_NAISSANCE_Y = 589f;
    public static final float LIEU_NAISSANCE_X = 306.3f, LIEU_NAISSANCE_Y = 589f;
    ...
    public static final float[] EC_ROW_Y = { 497f, 480f, 462f, 445f };
    public static final float EC_TOTAL_Y = 408f;

    public static final float OR_NOTE_CENTER_X = 400.9f;
    public static final float OR_POINTS_CENTER_X = 503.2f;
    public static final float[] OR_ROW_Y = { 497f, 480f };
    public static final float OR_TOTAL_Y = 408f;

    public static final float TOTAL_GENERAL_X = 228.7f, TOTAL_GENERAL_Y = 370f;

    public static final float DEC_TEXTE_X = 202.4f, DEC_TEXTE_Y = 345f;

    public static final float LIEU_DELIBERATION_X = 128.9f, JOUR_MOIS_X = 208.9f, ANNEE2_X = 268.9f, PIED_Y = 288f;

    // ---- Tampon "DAKAR, le [date du jour]" — sous "Cachet obligatoire" ----
    public static final float GENERE_X = 128.9f, GENERE_Y = 228f;
}
