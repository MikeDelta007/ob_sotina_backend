package com.officedubac.project.modules.S5.dto;

import com.officedubac.project.modules.S5.model.Enums.TypeSession;
...
public class RelevNoteS5SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresS5.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresS5.DEUXIEME_GROUPE), valeur = note sur 20 */
