...
public final class RelevNoteS5Coordinates {
    ...
    public static final float G1_TOTAL_Y = 328.0f;
    public static final float G2_TOTAL_Y = 274.4f;
    ...
    public static final float CTRL_FIRST_ROW_Y = 434.8f;
    public static final float CTRL_ROW_HEIGHT = 14.3f;

    // ---- Epreuves facultatives (droite, alimentent le TOTAL DEFINITIF) ----
    public static final float FAC_LANGUE_X = 470.9f, FAC_LANGUE_Y = 376.8f;
    public static final float FAC_ARTS_X = 525.0f, FAC_ARTS_Y = 356.0f;

    // ---- Epreuve facultative + Education Physique (gauche, alimentent le 2ème TOTAL) ----
    public static final float FAC_LANGUE_GAUCHE_X = 196.3f, FAC_LANGUE_GAUCHE_Y = 321.9f;
    public static final float FAC_ARTS_GAUCHE_X = 216.3f, FAC_ARTS_GAUCHE_Y = 302.5f;
    public static final float FAC_EDUCPHYS_GAUCHE_X = 165f, FAC_EDUCPHYS_GAUCHE_Y = 374.0f;
    ...
    public static final float EP_NOTE_X = 89.2f, EP_NOTE_Y = 372.7f;
    public static final float EP_POS_X = 196.3f, EP_POS_Y = 382.8f;
    public static final float EP_NEG_X = 196.3f, EP_NEG_Y = 362.0f;
    public static final float TOTAL_DEFINITIF_Y = 328.4f;

    // ---- Décisions du jury : texte libre sur la ligne "Le candidat a été déclaré ..." ----
    public static final float DEC1_TEXTE_X = 179.2f, DEC1_TEXTE_Y = 238f;
    public static final float DEC2_TEXTE_X = 425.7f, DEC2_TEXTE_Y = 307.1f;
    ...
    public static final float DEC2_LIEU_X = 310.7f, DEC2_JOUR_MOIS_X = 435.7f, DEC2_ANNEE2_X = 555.7f, DEC2_PIED_Y = 238.8f;

    // ---- Tampon "DAKAR, le [date du jour]" — sous "Cachet obligatoire ...
    // Président du Jury" ----
    public static final float DEC1_GENERE_X = 55f, DEC1_GENERE_Y = 134.2f;
    public static final float DEC2_GENERE_X = 320f, DEC2_GENERE_Y = 183.8f;
}
