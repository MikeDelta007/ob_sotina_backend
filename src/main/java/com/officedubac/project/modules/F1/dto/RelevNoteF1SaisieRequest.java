package com.officedubac.project.modules.F1.dto;

import com.officedubac.project.modules.F1.model.Enums.TypeSession;
...
public class RelevNoteF1SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresF1.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresF1.DEUXIEME_GROUPE), valeur = note sur 20 */
