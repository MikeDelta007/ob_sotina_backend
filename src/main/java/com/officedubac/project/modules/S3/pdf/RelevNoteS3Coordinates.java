...
public final class RelevNoteS3Coordinates {
    ...
    public static final float[] G1_ROW_Y = { 521.1f, 506.6f, 494.8f, 483.0f, 471.2f, 458.4f, 444.5f, 430.8f };

    public static final float G1_TOTAL_Y = 372.4f;
    public static final float G2_TOTAL_Y = 314.8f;
    ...
    public static final float CTRL_FIRST_ROW_Y = 467.6f;
    public static final float CTRL_ROW_HEIGHT = 14.3f;

    // ---- Epreuves facultatives (droite, alimentent le TOTAL DEFINITIF) ----
    public static final float FAC_LANGUE_X = 470.9f, FAC_LANGUE_Y = 413.1f;
    public static final float FAC_ARTS_X = 525.0f, FAC_ARTS_Y = 392.3f;

    // ---- Epreuve facultative + Education Physique (gauche, alimentent le 2ème TOTAL) ----
    public static final float FAC_LANGUE_GAUCHE_X = 196.3f, FAC_LANGUE_GAUCHE_Y = 354.3f;
    public static final float FAC_ARTS_GAUCHE_X = 216.3f, FAC_ARTS_GAUCHE_Y = 334.9f;
    public static final float FAC_EDUCPHYS_GAUCHE_X = 165f, FAC_EDUCPHYS_GAUCHE_Y = 406.3f;
    ...
    public static final float EP_NOTE_X = 89.2f, EP_NOTE_Y = 403.1f;
    public static final float EP_POS_X = 196.3f, EP_POS_Y = 413.1f;
    public static final float EP_NEG_X = 196.3f, EP_NEG_Y = 392.3f;
    public static final float TOTAL_DEFINITIF_Y = 372.7f;

    // ---- Décisions du jury : texte libre sur la ligne "Le candidat a été déclaré ..." ----
    public static final float DEC1_TEXTE_X = 179.2f, DEC1_TEXTE_Y = 283.4f;
    public static final float DEC2_TEXTE_X = 425.7f, DEC2_TEXTE_Y = 334.5f;

    // ---- Pied de page 1er groupe : "Fait à ... le ... 19..." (format court) ----
    public static final float DEC1_LIEU_X = 64.2f, DEC1_JOUR_MOIS_X = 129.2f, DEC1_ANNEE2_X = 229.2f, DEC1_PIED_Y = 222.5f;

    // ---- Pied de page 2eme groupe (format long) ----
    public static final float DEC2_LIEU_X = 310.7f, DEC2_JOUR_MOIS_X = 435.7f, DEC2_ANNEE2_X = 555.7f, DEC2_PIED_Y = 281.1f;
}
