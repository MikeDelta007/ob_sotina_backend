...
import com.officedubac.project.modules.S3.model.Enums.TypeSession;
...
public class RelevNoteS3SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresS3.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresS3.DEUXIEME_GROUPE), valeur = note sur 20 */
