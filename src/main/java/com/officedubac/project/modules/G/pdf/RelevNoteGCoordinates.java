 ...
 * extraction du texte du gabarit officiel "releve-G-template.pdf"
 ...
 */
public final class RelevNoteGCoordinates {

    private RelevNoteGCoordinates() { }
    ...
    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 370.3f, JURY_NUMERO_Y = 713.9f;
    public static final float ANNEE_X = 380.3f, ANNEE_Y = 695.6f;
    ...
    public static final float[] G1_ROW_Y = { 520.3f, 504.5f, 491.6f, 477.3f, 463.1f, 449.2f, 434.7f, 419.6f, 404.2f };

    public static final float G1_TOTAL_Y = 345.4f;
    public static final float G2_TOTAL_Y = 287.8f;
    ...
    public static final float REPORT_1ER_TOTAL_Y = 519.1f;
    ...
    public static final float CTRL_FIRST_ROW_Y = 455.4f;
    public static final float CTRL_ROW_HEIGHT = 14.3f;

    // ---- Epreuves facultatives (droite, alimentent le TOTAL DEFINITIF) ----
    public static final float FAC_LANGUE_X = 470.9f, FAC_LANGUE_Y = 386.1f;
    public static final float FAC_ARTS_X = 525.0f, FAC_ARTS_Y = 365.3f;

    // ---- Epreuve facultative + Education Physique (gauche, alimentent le 2ème TOTAL) ----
    public static final float FAC_LANGUE_GAUCHE_X = 196.3f, FAC_LANGUE_GAUCHE_Y = 327.6f;
    public static final float FAC_ARTS_GAUCHE_X = 216.3f, FAC_ARTS_GAUCHE_Y = 308.2f;
    public static final float FAC_EDUCPHYS_GAUCHE_X = 165f, FAC_EDUCPHYS_GAUCHE_Y = 379.3f;
    ...
    public static final float EP_NOTE_X = 89.2f, EP_NOTE_Y = 376.1f;
    public static final float EP_POS_X = 196.3f, EP_POS_Y = 386.1f;
    public static final float EP_NEG_X = 196.3f, EP_NEG_Y = 365.3f;
