package com.officedubac.project.modules.G.dto;

import com.officedubac.project.modules.G.model.Enums.TypeSession;
...
public class RelevNoteGSaisieRequest {
    ...
    /** clé = code matière (cf. MatieresG.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresG.DEUXIEME_GROUPE), valeur = note sur 20 */
