package com.officedubac.project.modules.S4.dto;

import com.officedubac.project.modules.S4.model.Enums.TypeSession;
...
public class RelevNoteS4SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresS4.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresS4.DEUXIEME_GROUPE), valeur = note sur 20 */
