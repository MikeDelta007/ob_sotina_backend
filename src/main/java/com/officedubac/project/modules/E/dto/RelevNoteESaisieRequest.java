package com.officedubac.project.modules.E.dto;
...
public class RelevNoteESaisieRequest {
    ...
    /** clé = code matière (cf. MatieresE.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresE.DEUXIEME_GROUPE), valeur = note sur 20 */
