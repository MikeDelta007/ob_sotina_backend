...
public final class RelevNoteECoordinates {
    ...
    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 542.6f, JURY_NUMERO_Y = 766.1f;
    public static final float ANNEE_X = 552.6f, ANNEE_Y = 741.7f;
    public static final float NUMERO_TABLE_X = 397.5f, NUMERO_TABLE_Y = 726.3f;
    ...
    public static final float[] G1_ROW_Y = { 554.7f, 540.1f, 527.1f, 512.8f, 498.8f, 484.8f, 470.7f, 456.2f, 441.8f };

    public static final float G1_TOTAL_Y = 383.7f;
    public static final float G2_TOTAL_Y = 326.1f;
    ...
    public static final float FAC_LANGUE_X = 466.4f, FAC_LANGUE_Y = 424.5f;
    public static final float FAC_ARTS_X = 521.0f, FAC_ARTS_Y = 403.7f;

    // ---- Epreuve facultative + Education Physique (gauche, alimentent le 2ème TOTAL) ----
    public static final float FAC_LANGUE_GAUCHE_X = 196.3f, FAC_LANGUE_GAUCHE_Y = 366.0f;
    public static final float FAC_ARTS_GAUCHE_X = 216.3f, FAC_ARTS_GAUCHE_Y = 346.5f;
    public static final float FAC_EDUCPHYS_GAUCHE_X = 165f, FAC_EDUCPHYS_GAUCHE_Y = 417.7f;
    ...
    public static final float EP_NOTE_X = 89.3f, EP_NOTE_Y = 414.4f;
    public static final float EP_POS_X = 196.3f, EP_POS_Y = 424.5f;
    public static final float EP_NEG_X = 196.3f, EP_NEG_Y = 403.7f;
    public static final float TOTAL_DEFINITIF_Y = 384.1f;

    // ---- Décisions du jury : texte libre sur la ligne "Le candidat a été déclaré ..." ----
    public static final float DEC1_TEXTE_X = 179.3f, DEC1_TEXTE_Y = 294.6f;
    public static final float DEC2_TEXTE_X = 415.7f, DEC2_TEXTE_Y = 345.8f;

    // ---- Pied de page 1er groupe : "Fait à ... le ... 19..." (format court) ----
    public static final float DEC1_LIEU_X = 64.3f, DEC1_JOUR_MOIS_X = 129.3f, DEC1_ANNEE2_X = 229.3f, DEC1_PIED_Y = 236.1f;

    // ---- Pied de page 2eme groupe (format long) ----
    public static final float DEC2_LIEU_X = 300.7f, DEC2_JOUR_MOIS_X = 425.7f, DEC2_ANNEE2_X = 545.7f, DEC2_PIED_Y = 294.6f;
}
