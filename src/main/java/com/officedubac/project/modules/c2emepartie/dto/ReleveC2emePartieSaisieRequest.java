...
public class ReleveC2emePartieSaisieRequest {
    ...
    /** clé = code matière (cf. MatieresC2emePartie.EPREUVES_ECRITES), valeur = note sur 20 */
    private Map<String, Integer> notesEcrites;

    /** clé = code matière (cf. MatieresC2emePartie.EPREUVES_ORALES), valeur = note sur 20 */
