package com.officedubac.project.modules.T1.dto;

import com.officedubac.project.modules.T1.model.Enums.TypeSession;
...
public class RelevNoteT1SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresT1.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresT1.DEUXIEME_GROUPE), valeur = note sur 20 */
