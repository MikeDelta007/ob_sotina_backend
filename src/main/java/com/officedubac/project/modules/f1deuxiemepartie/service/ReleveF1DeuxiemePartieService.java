package com.officedubac.project.modules.f1deuxiemepartie.service;
...
import com.officedubac.project.modules.f1deuxiemepartie.repository.ReleveF1DeuxiemePartieRepository;
...
public class ReleveF1DeuxiemePartieService {
    ...
    public Page<ReleveF1DeuxiemePartieResume> lister(String numeroTable, Pageable pageable) {
        Page<ReleveF1DeuxiemePartie> page = (numeroTable != null && !numeroTable.isBlank())
                ? repository.findByCandidat_NumeroTableContainingIgnoreCase(numeroTable, pageable)
                : repository.findAll(pageable);
        return page.map(this::versResume);
    }

    private ReleveF1DeuxiemePartieResume versResume(ReleveF1DeuxiemePartie r) {
        return new ReleveF1DeuxiemePartieResume(
                r.getId(),
