 ...
 * extraction du texte du gabarit officiel "releve-F1-2emePartie-template.pdf"
...
public final class ReleveF1DeuxiemePartieCoordinates {
    ...
    public static final float[] EC_ROW_Y = { 513.1f, 492.5f, 471.9f, 451.3f, 430.8f };
    ...
    public static final float[] OR_ROW_Y = { 513.1f, 492.5f, 471.9f, 451.3f };
    public static final float OR_TOTAL_Y = 410.1f;

    public static final float TOTAL_GENERAL_X = 280.0f, TOTAL_GENERAL_Y = 395.0f;
