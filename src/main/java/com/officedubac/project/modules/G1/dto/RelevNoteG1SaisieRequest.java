package com.officedubac.project.modules.G1.dto;

import com.officedubac.project.modules.G1.model.Enums.TypeSession;
...
public class RelevNoteG1SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresG1.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresG1.DEUXIEME_GROUPE), valeur = note sur 20 */
