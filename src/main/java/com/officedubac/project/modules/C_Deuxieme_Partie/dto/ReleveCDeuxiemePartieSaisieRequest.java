package com.officedubac.project.modules.C_Deuxieme_Partie.dto;

import java.time.LocalDate;
import java.util.Map;

public class ReleveCDeuxiemePartieSaisieRequest {
    ...
    /** clé = code matière (cf. MatieresCDeuxiemePartie.EPREUVES_ECRITES), valeur = note sur 20 */
    private Map<String, Integer> notesEcrites;

    /** clé = code matière (cf. MatieresCDeuxiemePartie.EPREUVES_ORALES), valeur = note sur 20 */
