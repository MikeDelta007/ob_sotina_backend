package com.officedubac.project.modules.F7.dto;
...
public class RelevNoteF7SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresF7.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresF7.DEUXIEME_GROUPE), valeur = note sur 20 */
