...
public final class RelevNoteF7Coordinates {
    ...
    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 537.5f, JURY_NUMERO_Y = 766.1f;
    public static final float ANNEE_X = 547.5f, ANNEE_Y = 741.7f;
    public static final float NUMERO_TABLE_X = 396.6f, NUMERO_TABLE_Y = 726.3f;
