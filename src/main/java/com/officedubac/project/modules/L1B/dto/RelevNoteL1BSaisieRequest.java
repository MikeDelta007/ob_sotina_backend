package com.officedubac.project.modules.L1B.dto;

import com.officedubac.project.modules.L1B.model.Enums.TypeSession;
...
public class RelevNoteL1BSaisieRequest {
    ...
    /** clé = code matière (cf. MatieresL1B.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresL1B.DEUXIEME_GROUPE), valeur = note sur 20 */
