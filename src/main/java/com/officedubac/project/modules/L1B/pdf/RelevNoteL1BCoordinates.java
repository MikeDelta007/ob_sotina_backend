 ...
 * extraction du texte du gabarit officiel "releve-L1B-template.pdf"
 ...
 */
public final class RelevNoteL1BCoordinates {

    private RelevNoteL1BCoordinates() { }
    ...
    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 370.3f, JURY_NUMERO_Y = 713.3f;
    public static final float ANNEE_X = 380.3f, ANNEE_Y = 695.0f;
