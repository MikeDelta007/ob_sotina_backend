package com.officedubac.project.modules.S2.dto;

import com.officedubac.project.modules.S2.model.Enums.TypeSession;
...
public class RelevNoteS2SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresS2.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresS2.DEUXIEME_GROUPE), valeur = note sur 20 */
