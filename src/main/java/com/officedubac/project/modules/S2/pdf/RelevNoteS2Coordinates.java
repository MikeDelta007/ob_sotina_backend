...
public final class RelevNoteS2Coordinates {
    ...
    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 370.3f, JURY_NUMERO_Y = 714.9f;
    public static final float ANNEE_X = 380.3f, ANNEE_Y = 696.7f;
    ...
    public static final float[] G1_ROW_Y = { 522.0f, 507.3f, 493.6f, 478.0f, 463.4f, 449.6f, 435.8f };

    public static final float G1_TOTAL_Y = 377.3f;
    public static final float G2_TOTAL_Y = 319.8f;
    ...
    public static final float CTRL_FIRST_ROW_Y = 470.5f;
    public static final float CTRL_ROW_HEIGHT = 14.3f;

    // ---- Epreuves facultatives (droite, alimentent le TOTAL DEFINITIF) ----
    public static final float FAC_LANGUE_X = 470.9f, FAC_LANGUE_Y = 418.1f;
    public static final float FAC_ARTS_X = 525.0f, FAC_ARTS_Y = 397.4f;

    // ---- Epreuve facultative + Education Physique (gauche, alimentent le 2ème TOTAL) ----
    public static final float FAC_LANGUE_GAUCHE_X = 196.3f, FAC_LANGUE_GAUCHE_Y = 359.3f;
    public static final float FAC_ARTS_GAUCHE_X = 216.3f, FAC_ARTS_GAUCHE_Y = 339.9f;
    public static final float FAC_EDUCPHYS_GAUCHE_X = 165f, FAC_EDUCPHYS_GAUCHE_Y = 411.4f;
    ...
    public static final float EP_NOTE_X = 89.2f, EP_NOTE_Y = 408.2f;
    public static final float EP_POS_X = 196.3f, EP_POS_Y = 418.1f;
    public static final float EP_NEG_X = 196.3f, EP_NEG_Y = 397.4f;
    public static final float TOTAL_DEFINITIF_Y = 377.7f;

    // ---- Décisions du jury : texte libre sur la ligne "Le candidat a été déclaré ..." ----
    public static final float DEC1_TEXTE_X = 179.2f, DEC1_TEXTE_Y = 288.4f;
    public static final float DEC2_TEXTE_X = 425.7f, DEC2_TEXTE_Y = 339.4f;

    // ---- Pied de page 1er groupe : "Fait à ... le ... 19..." (format court) ----
    public static final float DEC1_LIEU_X = 64.2f, DEC1_JOUR_MOIS_X = 129.2f, DEC1_ANNEE2_X = 229.2f, DEC1_PIED_Y = 227.5f;

    // ---- Pied de page 2eme groupe (format long) ----
    public static final float DEC2_LIEU_X = 310.7f, DEC2_JOUR_MOIS_X = 435.7f, DEC2_ANNEE2_X = 555.7f, DEC2_PIED_Y = 286.1f;
}
