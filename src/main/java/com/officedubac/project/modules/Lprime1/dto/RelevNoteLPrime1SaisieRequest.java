package com.officedubac.project.modules.Lprime1.dto;

import com.officedubac.project.modules.Lprime1.model.Enums.TypeSession;
...
public class RelevNoteLPrime1SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresLPrime1.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresLPrime1.DEUXIEME_GROUPE), valeur = note sur 20 */
