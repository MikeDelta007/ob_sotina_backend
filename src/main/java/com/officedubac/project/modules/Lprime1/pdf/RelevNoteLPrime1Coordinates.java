 ...
 * extraction du texte du gabarit officiel "releve-L'1-template.pdf"
 ...
 */
public final class RelevNoteLPrime1Coordinates {

    private RelevNoteLPrime1Coordinates() { }
    ...
    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 370.3f, JURY_NUMERO_Y = 696.3f;
    public static final float ANNEE_X = 380.3f, ANNEE_Y = 678f;
    ...
    public static final float[] G1_ROW_Y = { 500.0f, 485.4f, 471.7f, 456.2f, 441.5f, 427.7f, 413.9f };
    ...
    public static final float DEC1_TEXTE_X = 179.2f, DEC1_TEXTE_Y = 262.6f;
    public static final float DEC2_TEXTE_X = 425.7f, DEC2_TEXTE_Y = 331.7f;

    // ---- Pied de page 1er groupe : "Fait à ... le ... 19..." (format court) ----
    public static final float DEC1_LIEU_X = 64.2f, DEC1_JOUR_MOIS_X = 129.2f, DEC1_ANNEE2_X = 229.2f, DEC1_PIED_Y = 211.8f;

    // ---- Pied de page 2eme groupe (format long) ----
    public static final float DEC2_LIEU_X = 310.7f, DEC2_JOUR_MOIS_X = 435.7f, DEC2_ANNEE2_X = 555.7f, DEC2_PIED_Y = 263.4f;

    // ---- Tampon "DAKAR, le [date du jour]" — sous "Cachet obligatoire ...
    // Président du Jury" ----
    public static final float DEC1_GENERE_X = 64.2f, DEC1_GENERE_Y = 135f;
