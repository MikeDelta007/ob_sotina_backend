...
public final class RelevNoteLPrime1Coordinates {
    ...
    public static final float[] G1_ROW_Y = { 520.8f, 506.2f, 492.5f, 477.0f, 462.3f, 448.5f, 434.7f };
    ...
    public static final float FAC_LANGUE_GAUCHE_X = 196.3f, FAC_LANGUE_GAUCHE_Y = 359.0f;
    public static final float FAC_ARTS_GAUCHE_X = 216.3f, FAC_ARTS_GAUCHE_Y = 339.4f;
