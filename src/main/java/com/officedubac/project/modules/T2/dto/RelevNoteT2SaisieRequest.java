package com.officedubac.project.modules.T2.dto;

import com.officedubac.project.modules.T2.model.Enums.TypeSession;
...
public class RelevNoteT2SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresT2.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresT2.DEUXIEME_GROUPE), valeur = note sur 20 */
