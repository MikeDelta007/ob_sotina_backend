 ...
 * extraction du texte du gabarit officiel "releve-T2-template.pdf"
 ...
 */
public final class RelevNoteT2Coordinates {

    private RelevNoteT2Coordinates() { }
    ...
    public static final float G2_POINTS_CENTER_X = 510.7f;
    ...
    public static final float CTRL_POINTS_CENTER_X = 487.7f;
    public static final float CTRL_DIFF_CENTER_X = 526.0f;
    ...
    public static final float FAC_LANGUE_GAUCHE_X = 196.0f, FAC_LANGUE_GAUCHE_Y = 333.9f;
    public static final float FAC_ARTS_GAUCHE_X = 216.0f, FAC_ARTS_GAUCHE_Y = 314.5f;
    ...
    public static final float EP_NOTE_X = 89.0f, EP_NOTE_Y = 382.7f;
    public static final float EP_POS_X = 196.0f, EP_POS_Y = 392.8f;
    public static final float EP_NEG_X = 196.0f, EP_NEG_Y = 372.0f;
    public static final float TOTAL_DEFINITIF_Y = 352.4f;

    // ---- Décisions du jury : texte libre sur la ligne "Le candidat a été déclaré ..." ----
    public static final float DEC1_TEXTE_X = 179.0f, DEC1_TEXTE_Y = 263.0f;
