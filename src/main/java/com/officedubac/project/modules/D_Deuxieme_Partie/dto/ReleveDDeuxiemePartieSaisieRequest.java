package com.officedubac.project.modules.D_Deuxieme_Partie.dto;

import java.time.LocalDate;
import java.util.Map;

public class ReleveDDeuxiemePartieSaisieRequest {
    ...
    /** clé = code matière (cf. MatieresDDeuxiemePartie.EPREUVES_ECRITES), valeur = note sur 20 */
    private Map<String, Integer> notesEcrites;

    /** clé = code matière (cf. MatieresDDeuxiemePartie.EPREUVES_ORALES), valeur = note sur 20 */
    private Map<String, Integer> notesOrales;

    /** Ajustement EPS (+/-) tel que saisi par le jury */
