...
/**
 * Bloc "EPR. DE CONTROLE" du formulaire D : Matières choisies / Rappel des
 * points obtenus au 1er groupe / Nouvelle note sur 20 / Cœff. / Points au
 * contrôle / Différence en plus.
 *
 * Comme la série B, ce formulaire a une colonne "Cœff" propre à l'épreuve
 * de contrôle : les points au contrôle = nouvelle note × coefficient.
 */
