...
@Document(collection = "relevesNotesD")
public class ReleveD {
    ...
    // ---- 1er groupe d'épreuves (barème 460) ----
    private List<NoteEpreuve> notesPremierGroupe = new ArrayList<>();
    private Integer totalPremierGroupe; // sur 460 (= 1er TOTAL = 2eme TOTAL, reporté)
    ...
    private Integer totalDefinitif; // sur 460
