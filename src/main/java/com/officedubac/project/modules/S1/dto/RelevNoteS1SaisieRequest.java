package com.officedubac.project.modules.S1.dto;

import com.officedubac.project.modules.S1.model.Enums.TypeSession;
...
public class RelevNoteS1SaisieRequest {
    ...
    /** clé = code matière (cf. MatieresS1.PREMIER_GROUPE), valeur = note sur 20 */
    private Map<String, Integer> notesPremierGroupe;

    /** clé = code matière (cf. MatieresS1.DEUXIEME_GROUPE), valeur = note sur 20 */
