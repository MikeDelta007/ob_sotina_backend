package com.officedubac.project.modules.S1.model;

import java.util.List;

import static com.officedubac.project.modules.S1.model.GroupeEpreuves.DEUXIEME;
import static com.officedubac.project.modules.S1.model.GroupeEpreuves.PREMIER;
import static com.officedubac.project.modules.S1.model.TypeEpreuve.ECRIT;
import static com.officedubac.project.modules.S1.model.TypeEpreuve.ORAL;

/**
 * Référentiel figé des matières, coefficients et barèmes de la série S1
 * (Mathématiques et Sciences Physiques), tel qu'imprimé sur le gabarit officiel de
 * l'Office du Baccalauréat.
 */
public final class MatieresS1 {
    ...
    public static final Matiere SC_NAT = new Matiere("SC_NAT", "Sciences Naturelles", 2, 40, ECRIT, PREMIER);
    public static final Matiere ANGLAIS = new Matiere("ANGLAIS", "Anglais", 2, 40, ORAL, PREMIER);

    public static final List<Matiere> PREMIER_GROUPE = List.of(FRANCAIS, PHILO, MATH, SC_PHYS, HIST_GEO, SC_NAT, ANGLAIS);
    ...
    public static Matiere findByCode(String code) {
        return java.util.stream.Stream.concat(PREMIER_GROUPE.stream(), DEUXIEME_GROUPE.stream())
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Matière inconnue pour la série S1 : " + code));
    }
}
