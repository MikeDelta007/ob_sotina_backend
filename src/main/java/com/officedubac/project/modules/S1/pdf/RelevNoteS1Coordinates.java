 ...
 * extraction du texte du gabarit officiel "releve-S1-template.pdf"
 ...
 */
public final class RelevNoteS1Coordinates {

    private RelevNoteS1Coordinates() { }
    ...
    // ---- En-tête ----
    public static final float JURY_NUMERO_X = 370.3f, JURY_NUMERO_Y = 694.7f;
    public static final float ANNEE_X = 380.3f, ANNEE_Y = 676.5f;
    ...
    public static final float[] G1_ROW_Y = { 500.0f, 485.5f, 471.8f, 456.2f, 441.6f, 427.8f, 414.0f };
