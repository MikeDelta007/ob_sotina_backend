...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    /***
     ...
     //
     dto.setName(profil.getName().name());

     dto.setAdd_user(profil.isAddUser());
     dto.setUpdate_password(profil.isUpdatePassword());
     dto.setGrant_user(profil.isGrantUser());
     dto.setRevoke_user(profil.isAddUser());
     //
     dto.setManage_settings(profil.isManageSettings());
     //
     dto.setAdd_date(profil.isAddDate());
     dto.setUpdate_date(profil.isUpdateDate());
     dto.setDelete_date(profil.isDeleteDate());
     dto.setShare_date(profil.isShareDate());
     dto.setView_plan(profil.isViewPlan());
     //
     dto.setAdd_candidate(profil.isAddCandidate());
     dto.setView_candidate(profil.isViewCandidate());
     dto.setUpdate_candidate(profil.isUpdateCandidate());
     dto.setDelete_candidate(profil.isDeleteCandidate());
     dto.setAccept_candidate(profil.isAcceptCandidate());
     dto.setReject_candidate(profil.isRejectCandidate());
     //
     dto.setAdd_examinator(profil.isAddExaminator());
     dto.setUpdate_examinator(profil.isUpdateExaminator());
     //
     dto.setAdd_SJ(profil.isAddSJ());
     dto.setAdd_SJ(profil.isUpdateSJ());
     //
     dto.setAdd_PJ(profil.isAddPJ());
     dto.setUpdate_PJ(profil.isUpdatePJ());
     //
     dto.setPlan_Intrant(profil.isPlanIntrant());
