...
@Repository
public class SourceCandidatCGSCustomRepositoryImpl implements SourceCandidatCGSCustomRepository {
    ...
    public Page<String> findDistinctAcademies(Pageable pageable) {
        ...
        Aggregation aggregation = Aggregation.newAggregation(
                Aggregation.match(Criteria.where("academia").ne(null)),
                Aggregation.group("academia"),
        ...
        AggregationResults<Document> results =
                mongoTemplate.aggregate(aggregation, "sourceCandidatCGS", Document.class);
