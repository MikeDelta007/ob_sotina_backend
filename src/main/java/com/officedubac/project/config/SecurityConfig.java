    ...
    public SecurityFilterChain jwtFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/releves-a1-2eme-partie/**").permitAll()
                        .requestMatchers("/api/releves-a2-2eme-partie/**").permitAll()
                        .requestMatchers("/api/releves-a3/**").permitAll()
                        .requestMatchers("/api/releves-a3-2eme-partie/**").permitAll()
                        .requestMatchers("/api/releves-a4/**").permitAll()
                        .requestMatchers("/api/releves-b/**").permitAll()
                        .requestMatchers("/api/releves-c-2eme-partie/**").permitAll()
                        .requestMatchers("/api/releves-d/**").permitAll()
                        .requestMatchers("/api/releves-d-2eme-partie/**").permitAll()
                        .requestMatchers("/api/releves-e/**").permitAll()
                        .requestMatchers("/api/releves-f1/**").permitAll()
                        .requestMatchers("/api/releves-f1-2eme-partie/**").permitAll()
                        .requestMatchers("/api/releves-f2/**").permitAll()
