...
public class CandidatController
{
    ...
    public ResponseEntity<Void> decisionCandidat(@RequestParam String idCdt) throws Exception {
        this.candidatService.deleteCandidat(idCdt);
    ...
    @PostMapping(value = "/found-cdt-by-subject")
    public ResponseEntity<List<Candidat>> getCandidatsBySubject(@RequestParam String sujet) throws Exception {
        return ResponseEntity.ok(this.candidatService.getCandidatsBySubject(sujet));
    }
