...
public class ParametrageController
{
    ...
    public ResponseEntity<Etablissement> updateEtabl(@RequestParam String idEt, @RequestBody EtablissementDTO etabDTO) throws Exception
    {
        return ResponseEntity.ok(this.parametrageService.updateEtab(idEt, etabDTO));
    }
